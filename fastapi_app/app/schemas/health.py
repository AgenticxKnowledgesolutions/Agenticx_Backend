...
class RootResponse(BaseModel):
    ...
    environment: str = Field(description="The current deployment environment")
    health: str = Field(description="The path to the health check endpoint", default="/health")
    docs: str = Field(description="The path to the API documentation", default="/docs")
